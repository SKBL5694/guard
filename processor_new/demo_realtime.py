...
class DemoRealtime(IO):
    ...
    def start(self):
        ...
        label_name_path = './config/st_gcn/guard/V6/xview/label.txt'
    ...
    def get_parser(add_help=False):
        ...
        # checkpoint kinetics
        parser.set_defaults(
            config='./config/st_gcn/guard/V7/xviewnobias/demo_realtime.yaml')
...
class naive_pose_tracker():
    ...
    def __init__(self, data_frame=100, num_joint=18, max_frame_dis=np.inf):
